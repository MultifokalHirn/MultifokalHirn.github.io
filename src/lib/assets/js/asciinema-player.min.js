var AsciinemaPlayer = (function (A) {
	...
	const I = Symbol('solid-proxy'),
		B = Symbol('solid-track'),
		Q = { equals: (A, g) => A === g };
	let C = J;
	const E = 1,
		e = 2,
		i = { owned: null, cleanups: null, context: null, owner: null };
	var t = null;
	let o = null,
		s = null,
		n = null,
	...
	function c(A, g) {
		const I = s,
			B = t,
			Q = 0 === A.length,
			C = Q ? i : { owned: null, cleanups: null, context: null, owner: void 0 === g ? B : g },
			E = Q ? A : () => A(() => y(() => U(C)));
		((t = C), (s = null));
		try {
			return R(E, !0);
	...
	function D(A, g) {
		...
		return [u.bind(I), (A) => ('function' == typeof A && (A = A(I.value)), F(I, A))];
	}
	function w(A, g, I) {
		d(f(A, g, !1, E));
	}
	function h(A, g, I) {
		I = I ? Object.assign({}, Q, I) : Q;
		const B = f(A, g, !0, 0);
		return (
			(B.observers = null),
	...
	function G(A) {
		!(function (A, g, I) {
			C = p;
			const B = f(A, g, !1, E);
			((B.user = !0), r ? r.push(B) : d(B));
		})(() => y(A));
	}
	function M(A) {
		return (null === t || (null === t.cleanups ? (t.cleanups = [A]) : t.cleanups.push(A)), A);
	}
	function k() {
		return s;
	}
	...
	function u() {
		...
		if (this.sources && (this.state || A))
			if (this.state === E || A) d(this);
			else {
				const A = n;
				((n = null), R(() => S(this), !1), (n = A));
			}
		if (s) {
			const A = this.observers ? this.observers.length : 0;
			(s.sources
				? (s.sources.push(this), s.sourceSlots.push(A))
				: ((s.sources = [this]), (s.sourceSlots = [A])),
				this.observers
					...
					R(() => {
						for (let g = 0; g < A.observers.length; g += 1) {
							const I = A.observers[g],
								B = o && o.running;
							(B && o.disposed.has(I),
								((B && !I.tState) || (!B && !I.state)) &&
									(I.pure ? n.push(I) : r.push(I), I.observers && L(I)),
								B || (I.state = E));
						}
		...
		((s = t = A),
			(function (A, g, I) {
				...
				try {
					...
					(A.pure && ((A.state = E), A.owned && A.owned.forEach(U), (A.owned = null)), H(g));
				}
				(!A.updatedAt || A.updatedAt <= I) &&
					(null != A.updatedAt && 'observers' in A ? F(A, B) : (A.value = B), (A.updatedAt = I));
			})(A, A.value, B),
			(s = I),
			(t = g));
	}
	function f(A, g, I, B = E, Q) {
		const C = {
			fn: A,
			state: B,
			updatedAt: null,
		...
		return (null === t || (t !== i && (t.owned ? t.owned.push(C) : (t.owned = [C]))), C);
	}
	function Y(A) {
		const g = o;
		if (0 === A.state || g) return;
		if (A.state === e || g) return S(A);
		if (A.suspense && y(A.suspense.inFallback)) return A.suspense.effects.push(A);
		const I = [A];
		for (; (A = A.owner) && (!A.updatedAt || A.updatedAt < a); ) (A.state || g) && I.push(A);
		for (let B = I.length - 1; B >= 0; B--)
			if ((A = I[B]).state === E || g) d(A);
			else if (A.state === e || g) {
				const g = n;
				((n = null), R(() => S(A, I[0]), !1), (n = g));
			}
	}
	function R(A, g) {
		if (n) return A();
	...
	function J(A) {
		for (let g = 0; g < A.length; g++) Y(A[g]);
	}
	function p(A) {
		let I,
			B = 0;
		...
		var Q;
		for (g.context && (g.context = Q), I = 0; I < B; I++) Y(A[I]);
	}
	function S(A, g) {
		const I = o;
		A.state = 0;
		for (let B = 0; B < A.sources.length; B += 1) {
			const Q = A.sources[B];
			Q.sources && (Q.state === E || I ? Q !== g && Y(Q) : (Q.state === e || I) && S(Q, g));
		}
	}
	function L(A) {
		const g = o;
		for (let I = 0; I < A.observers.length; I += 1) {
			...
			(B.state && !g) || ((B.state = e), B.pure ? n.push(B) : r.push(B), B.observers && L(B));
		}
	}
	function U(A) {
		let g;
		...
		if (A.owned) {
			for (g = 0; g < A.owned.length; g++) U(A.owned[g]);
			A.owned = null;
		}
		if (A.cleanups) {
	...
	function K(A) {
		if ('function' == typeof A && !A.length) return K(A());
		if (Array.isArray(A)) {
			const g = [];
						...
						return (
							...
							y(() => {
								let A,
									...
									y = s.length;
								if (0 === y)
									(0 !== e && (q(E), (E = []), (Q = []), (C = []), (e = 0), i && (i = [])),
										I.fallback &&
											((Q = [m]), (C[0] = c((A) => ((E[0] = A), I.fallback()))), (e = 1)));
								else if (0 === e) {
									for (C = new Array(y), o = 0; o < y; o++) ((Q[o] = s[o]), (C[o] = c(n)));
									e = y;
								} else {
									for (
										B = new Array(y),
									...
									for (w = e - 1, h = y - 1; w >= D && h >= D && Q[w] === s[h]; w--, h--)
										((B[h] = C[w]), (r[h] = E[w]), i && (a[h] = i[w]));
									for (A = new Map(), g = new Array(h + 1), o = h; o >= D; o--)
										((l = s[o]), (t = A.get(l)), (g[o] = void 0 === t ? -1 : t), A.set(l, o));
									for (t = D; t <= w; t++)
										((l = Q[t]),
											(o = A.get(l)),
											void 0 !== o && -1 !== o
									...
									for (o = D; o < y; o++)
										o in B
											? ((C[o] = B[o]), (E[o] = r[o]), i && ((i[o] = a[o]), i[o](o)))
											: (C[o] = c(n));
									((C = C.slice(0, (e = y))), (Q = s.slice(0)));
								}
								return C;
							})
						);
							...
							y(() => {
								if (0 === o.length)
									return (
										0 !== t && (q(e), (e = []), (C = []), (E = []), (t = 0), (i = [])),
										I.fallback &&
											((C = [m]), (E[0] = c((A) => ((e[0] = A), I.fallback()))), (t = 1)),
										E
									);
								for (
									C[0] === m && (e[0](), (e = []), (C = []), (E = []), (t = 0)), Q = 0;
									Q < o.length;
									Q++
								)
									Q < C.length && C[Q] !== o[Q] ? i[Q](() => o[Q]) : Q >= C.length && (E[Q] = c(s));
								for (; Q < C.length; Q++) e[Q]();
								return (
									(t = i.length = e.length = o.length),
									(C = o.slice(0)),
									(E = E.slice(0, t))
								);
							})
	...
	function j(A) {
		let g = !1;
		const I = A.keyed,
			B = h(() => A.when, void 0, { equals: (A, I) => (g ? A === I : !A == !I) });
		return h(
			() => {
				const Q = B();
				if (Q) {
					const B = A.children,
						C = 'function' == typeof B && B.length > 0;
					return ((g = I || C), C ? y(() => B(Q)) : B);
				}
				return A.fallback;
			},
			void 0,
	...
	function T(A) {
			...
			Q = h(
				() => {
					...
					for (let g = 0; g < A.length; g++) {
						const B = A[g].when;
						if (B) return ((I = !!A[g].keyed), [g, B, A[g]]);
					}
					return [-1];
				},
				void 0,
		...
		return h(
			() => {
				const [B, C, E] = Q();
				if (B < 0) return A.fallback;
				const e = E.children,
					i = 'function' == typeof e && e.length > 0;
				return ((g = I || i), i ? y(() => e(C)) : e);
			},
			void 0,
			void 0
		);
	...
	function O(A, g, I, B = {}) {
		...
		return (
			c((B) => {
				((Q = B), g === document ? A() : AA(g, A(), g.firstChild ? null : void 0, I));
			}, B.owner),
			() => {
				(Q(), (g.textContent = ''));
			}
	...
	function z(A, g = window.document) {
		const I = g[W] || (g[W] = new Set());
		for (let B = 0, Q = A.length; B < Q; B++) {
			const Q = A[B];
			I.has(Q) || (I.add(Q), g.addEventListener(Q, gA));
		}
	}
	function V(A, g) {
	...
	function P(A, g, I, B) {
		if (B) Array.isArray(I) ? ((A[`$$${g}`] = I[0]), (A[`$$${g}Data`] = I[1])) : (A[`$$${g}`] = I);
		else if (Array.isArray(I)) {
			const B = I[0];
			A.addEventListener(g, (I[0] = (g) => B.call(A, I[1], g)));
		} else A.addEventListener(g, I);
	}
	function _(A, g, I) {
		if (!g)
			return I
				? (function (A, g, I) {
						null == I ? A.removeAttribute(g) : A.setAttribute(g, I);
					})(A, 'style')
				: g;
		const B = A.style;
		if ('string' == typeof g) return (B.cssText = g);
		let Q, C;
		for (C in ('string' == typeof I && (B.cssText = I = void 0), I || (I = {}), g || (g = {}), I))
	...
	function AA(A, g, I, B) {
		if ((void 0 === I || B || (B = []), 'function' != typeof g)) return IA(A, g, B, I);
		w((B) => IA(A, g(), B, I), B);
	}
	function gA(A) {
		const I = `$$${A.type}`;
		let B = (A.composedPath && A.composedPath()[0]) || A.target;
		for (
			A.target !== B && Object.defineProperty(A, 'target', { configurable: !0, value: B }),
				Object.defineProperty(A, 'currentTarget', { configurable: !0, get: () => B || document }),
				g.registry &&
					!g.done &&
					((g.done = !0),
			...
			if (g && !B.disabled) {
				const Q = B[`${I}Data`];
				if ((void 0 !== Q ? g.call(B, Q, A) : g.call(B, A), A.cancelBubble)) return;
			}
			B = B._$host || B.parentNode || B.host;
		}
	}
	function IA(A, I, B, Q, C) {
		for (g.context && !B && (B = [...A.childNodes]); 'function' == typeof B; ) B = B();
		if (I === B) return B;
		const E = typeof I,
			e = void 0 !== Q;
		if (((A = (e && B[0] && B[0].parentNode) || A), 'string' === E || 'number' === E)) {
			if (g.context) return B;
			if (('number' === E && (I = I.toString()), e)) {
				let g = B[0];
				(g && 3 === g.nodeType ? (g.data = I) : (g = document.createTextNode(I)),
					(B = CA(A, B, Q, g)));
			} else B = '' !== B && 'string' == typeof B ? (A.firstChild.data = I) : (A.textContent = I);
		} else if (null == I || 'boolean' === E) {
			if (g.context) return B;
			B = CA(A, B, Q);
		} else {
			if ('function' === E)
			...
			if (Array.isArray(I)) {
				const E = [],
					i = B && Array.isArray(B);
				if (BA(E, I, B, C)) return (w(() => (B = IA(A, E, B, Q, !0))), () => B);
				if (g.context) {
					if (!E.length) return B;
					for (let A = 0; A < E.length; A++) if (E[A].parentNode) return (B = E);
				}
				if (0 === E.length) {
					if (((B = CA(A, B, Q)), e)) return B;
				} else
					i
						? 0 === B.length
							? QA(A, E, Q)
							: (function (A, g, I) {
									...
									for (; E < Q || e < C; )
										if (g[E] !== I[e]) {
											for (; g[Q - 1] === I[C - 1]; ) (Q--, C--);
											if (Q === E) {
												const g = C < B ? (e ? I[e - 1].nextSibling : I[C - e]) : i;
												for (; e < C; ) A.insertBefore(I[e++], g);
											} else if (C === e)
												for (; E < Q; ) ((t && t.has(g[E])) || g[E].remove(), E++);
											else if (g[E] === I[C - 1] && I[e] === g[Q - 1]) {
												const B = g[--Q].nextSibling;
												(A.insertBefore(I[e++], g[E++].nextSibling),
												...
												if (null != B)
													if (e < B && B < C) {
														let i,
															o = E,
															s = 1;
														for (; ++o < Q && o < C && null != (i = t.get(g[o])) && i === B + s; )
															s++;
														if (s > B - e) {
															const Q = g[E];
															for (; e < B; ) A.insertBefore(I[e++], Q);
														} else A.replaceChild(I[e++], g[E++]);
													} else E++;
												else g[E++].remove();
											}
										} else (E++, e++);
				...
				if (g.context && I.parentNode) return (B = e ? [I] : I);
				if (Array.isArray(B)) {
					if (e) return (B = CA(A, B, Q, I));
					CA(A, B, null, I);
				} else
					null != B && '' !== B && A.firstChild
	...
	function BA(A, g, I, B) {
		...
		for (let C = 0, E = g.length; C < E; C++) {
			...
			else if (Array.isArray(E)) Q = BA(A, E, e) || Q;
			else if ('function' == typeof E)
				if (B) {
					for (; 'function' == typeof E; ) E = E();
					Q = BA(A, Array.isArray(E) ? E : [E], Array.isArray(e) ? e : [e]) || Q;
				} else (A.push(E), (Q = !0));
			else {
				const g = String(E);
	...
	const sA = new TextDecoder('utf-8', { ignoreBOM: !0, fatal: !0 });
	sA.decode();
	let nA = null;
	function rA() {
		return ((null !== nA && 0 !== nA.byteLength) || (nA = new Uint8Array(EA.memory.buffer)), nA);
	}
	function aA(A, g) {
		return sA.decode(rA().subarray(A, A + g));
	}
	function cA(A) {
		tA === eA.length && eA.push(eA.length + 1);
		const g = tA;
		return ((tA = eA[g]), (eA[g] = A), g);
	}
	function DA(A) {
		const g = typeof A;
	...
	let wA = 0;
	const hA = new TextEncoder('utf-8'),
		lA =
	...
	function yA(A, g, I) {
		...
		if (E !== B) {
			(0 !== E && (A = A.slice(E)), (Q = I(Q, B, (B = E + 3 * A.length))));
			const g = rA().subarray(Q + E, Q + B);
			E += lA(A, g).written;
		}
		return ((wA = E), Q);
	}
	let GA = null;
	function MA() {
		return ((null !== GA && 0 !== GA.byteLength) || (GA = new Int32Array(EA.memory.buffer)), GA);
	}
	let kA = null;
	function NA(A, g) {
		return ((null !== kA && 0 !== kA.byteLength) || (kA = new Uint32Array(EA.memory.buffer)),
		kA).subarray(A / 4, A / 4 + g);
	}
	class uA {
		static __wrap(A) {
		...
		free() {
			...
			EA.__wbg_vtwrapper_free(A);
		}
		feed(A) {
			const g = yA(A, EA.__wbindgen_malloc, EA.__wbindgen_realloc),
				I = wA;
			return oA(EA.vtwrapper_feed(this.ptr, g, I));
		}
		inspect() {
			try {
				const I = EA.__wbindgen_add_to_stack_pointer(-16);
				EA.vtwrapper_inspect(I, this.ptr);
				var A = MA()[I / 4 + 0],
					g = MA()[I / 4 + 1];
				return aA(A, g);
			} finally {
				(EA.__wbindgen_add_to_stack_pointer(16), EA.__wbindgen_free(A, g));
			}
		}
		get_size() {
			try {
				const B = EA.__wbindgen_add_to_stack_pointer(-16);
				EA.vtwrapper_get_size(B, this.ptr);
				var A = MA()[B / 4 + 0],
					g = MA()[B / 4 + 1],
					I = NA(A, g).slice();
				return (EA.__wbindgen_free(A, 4 * g), I);
			} finally {
				EA.__wbindgen_add_to_stack_pointer(16);
			}
		}
		get_line(A) {
			return oA(EA.vtwrapper_get_line(this.ptr, A));
		}
		get_cursor() {
			return oA(EA.vtwrapper_get_cursor(this.ptr));
		}
	}
	function FA() {
		const A = { wbg: {} };
	...
	async function fA(A) {
		...
		('string' == typeof A ||
			...
			(A = fetch(A));
		const { instance: I, module: B } = await (async function (A, g) {
	...
	var YA = Object.freeze({
		__proto__: null,
		VtWrapper: uA,
		create: function (A, g, I, B) {
			const Q = EA.create(A, g, I, B);
			return uA.__wrap(Q);
		},
		default: fA,
		initSync: function (A) {
			...
			return (
				...
				dA(new WebAssembly.Instance(A, g), A)
			);
		}
	});
	const RA = [
	...
	const pA = (function (A) {
		...
		for (let I = 0, C = 0; I < B; I += 4, C += 3)
			((g =
				(JA(A.charCodeAt(I)) << 18) |
				(JA(A.charCodeAt(I + 1)) << 12) |
				(JA(A.charCodeAt(I + 2)) << 6) |
				JA(A.charCodeAt(I + 3))),
				(Q[C] = g >> 16),
				(Q[C + 1] = (g >> 8) & 255),
				(Q[C + 2] = 255 & g));
		...
		return 'number' == typeof A
			...
			: 'string' == typeof A
				? A.split(':')
						.reverse()
						.map(parseFloat)
						.reduce((A, g, I) => A + g * Math.pow(60, I))
				: void 0;
	}
	class LA {
		constructor() {
	...
	class mA extends KA {
		async init() {
			try {
				return (await this.core.initializeDriver(), this.core.setState('stopped'));
			} catch (A) {
				throw (this.core.setState('errored'), A);
			}
		}
		async play() {
		...
		onEnter(A) {
			(this.core.dispatchEvent('stopped'),
				'paused' === A.reason
					...
					: 'ended' === A.reason && this.core.dispatchEvent('ended'));
		}
		play() {
			return (this.core.dispatchEvent('play'), this.doPlay());
		}
		async doPlay() {
			const A = await this.driver.play();
			!0 === A
				? this.core.setState('playing')
				: 'function' == typeof A && (this.core.setState('playing'), (this.driver.stop = A));
		}
		togglePlay() {
			return this.play();
		}
	...
	class bA extends KA {
		...
		pause() {
			!0 === this.driver.pause() && this.core.setState('stopped', { reason: 'paused' });
		}
		togglePlay() {
			return this.pause();
		}
	...
	class TA {
		...
		dispatchEvent(A) {
			...
			for (const I of this.eventHandlers.get(A)) I(g);
		}
		async init() {
			this.wasm = await HA;
			const A = this.feed.bind(this),
				g = this.now.bind(this),
				I = this.resetVt.bind(this),
				B = this.setState.bind(this),
				Q = 'npt' === this.poster.type ? this.poster.value : void 0;
			((this.driver = this.driverFn(
				{
					feed: A,
					onInput: (A) => {
						this.dispatchEvent('input', { data: A });
					},
					onMarker: (A) => {
						let { index: g, time: I, label: B } = A;
						this.dispatchEvent('marker', { index: g, time: I, label: B });
					},
					reset: I,
					now: g,
				...
				'function' == typeof this.driver && (this.driver = { play: this.driver }),
				(this.preload || void 0 !== Q) && this.withState((A) => A.init()));
			const C = 'text' === this.poster.type ? this.renderPoster(this.poster.value) : void 0,
				E = { isPausable: !!this.driver.pause, isSeekable: !!this.driver.seek, poster: C };
			if (
				...
				let g = new UA();
				((this.driver.play = () => ((g = new LA(this.speed)), A())),
		...
		getChangedLines() {
			if (this.changedLines.size > 0) {
				...
				for (const I of this.changedLines)
					I < g && A.set(I, { id: I, segments: this.vt.get_line(I) });
				return (this.changedLines.clear(), A);
			}
		}
		getCursor() {
			return (
				void 0 === this.cursor && this.vt && (this.cursor = this.vt.get_cursor() ?? !1),
				this.cursor
			);
		}
		getCurrentTime() {
		...
		setState(A) {
			...
			if (((this.stateName = A), 'playing' === A)) this.state = new bA(this);
			else if ('stopped' === A) this.state = new qA(this);
			else if ('loading' === A) this.state = new vA(this);
			else if ('offline' === A) this.state = new xA(this);
			else {
				if ('errored' !== A) throw `invalid state: ${A}`;
				this.state = new jA(this);
			}
			return (this.state.onEnter(g), this.state);
		}
		feed(A) {
			(this.doFeed(A), this.dispatchEvent('terminalUpdate'));
		}
		doFeed(A) {
			const [g, I] = this.vt.feed(A);
			if ((g.forEach((A) => this.changedLines.add(A)), (this.cursor = void 0), I)) {
				const [A, g] = this.vt.get_size();
				((this.vt.cols = A),
					(this.vt.rows = g),
					this.logger.debug(`core: vt resize (${A}x${g})`),
					this.dispatchEvent('resize', { cols: A, rows: g }));
			}
		}
		now() {
		...
		initializeVt(A, g) {
			...
			for (let A = 0; A < g; A++) this.changedLines.add(A);
		}
		parsePoster(A) {
			return 'string' != typeof A
				...
				: 'data:text/plain,' == A.substring(0, 16)
					...
					: 'npt:' == A.substring(0, 4)
						? { type: 'npt', value: SA(A.substring(4)) }
						: {};
		}
		renderPoster(A) {
			const g = this.cols ?? 80,
				I = this.rows ?? 24;
			this.logger.debug(`core: poster init (${g}x${I})`);
			const B = this.wasm.create(g, I, !1, 0);
			A.forEach((A) => B.feed(A));
			const Q = B.get_cursor() ?? !1,
				C = [];
			for (let A = 0; A < I; A++) C.push({ id: A, segments: B.get_line(A) });
			return { cursor: Q, lines: C };
		}
		normalizeMarkers(A) {
			if (Array.isArray(A)) return A.map((A) => ('number' == typeof A ? [A, ''] : A));
		}
	}
	const ZA = Symbol('store-raw'),
		WA = Symbol('store-node'),
		OA = Symbol('store-name');
	function XA(A, g) {
		let B = A[I];
		if (!B && (Object.defineProperty(A, I, { value: (B = new Proxy(A, gg)) }), !Array.isArray(A))) {
			const g = Object.keys(A),
				I = Object.getOwnPropertyDescriptors(A);
			for (let Q = 0, C = g.length; Q < C; Q++) {
				const C = g[Q];
				I[C].get &&
					Object.defineProperty(A, C, { enumerable: I[C].enumerable, get: I[C].get.bind(B) });
			}
		}
		return B;
	}
	function zA(A) {
		...
		return (
			null != A &&
			'object' == typeof A &&
			(A[I] || !(g = Object.getPrototypeOf(A)) || g === Object.prototype || Array.isArray(A))
		);
	}
	function VA(A, g = new Set()) {
		let I, B, Q, C;
		if ((I = null != A && A[ZA])) return I;
		if (!zA(A) || g.has(A)) return A;
		if (Array.isArray(A)) {
			Object.isFrozen(A) ? (A = A.slice(0)) : g.add(A);
			for (let I = 0, C = A.length; I < C; I++) ((Q = A[I]), (B = VA(Q, g)) !== Q && (A[I] = B));
		} else {
			Object.isFrozen(A) ? (A = Object.assign({}, A)) : g.add(A);
			const I = Object.keys(A),
				E = Object.getOwnPropertyDescriptors(A);
			for (let e = 0, i = I.length; e < i; e++)
				((C = I[e]), E[C].get || ((Q = A[C]), (B = VA(Q, g)) !== Q && (A[C] = B)));
		}
		return A;
	}
	function PA(A) {
		let g = A[WA];
		return (g || Object.defineProperty(A, WA, { value: (g = {}) }), g);
	}
	function _A(A, g, I) {
		return A[g] || (A[g] = Ag(I));
	}
	...
	function Ag(A) {
		const [g, I] = D(A, { equals: !1, internal: !0 });
		return ((g.$ = I), g);
	}
	const gg = {
		get(A, g, Q) {
			...
			let e = E ? C[g]() : A[g];
			if (g === WA || '__proto__' === g) return e;
			if (!E) {
				const I = Object.getOwnPropertyDescriptor(A, g);
				!k() ||
					('function' == typeof e && !A.hasOwnProperty(g)) ||
					(I && I.get) ||
					(e = _A(C, g, e)());
			}
			return zA(e) ? XA(e) : e;
		...
		has(A, g) {
			return (
				...
				g === WA ||
				'__proto__' === g ||
				(this.get(A, g, A), g in A)
			);
		},
		set: () => !0,
		deleteProperty: () => !0,
		ownKeys: function (A) {
			return ($A(A), Reflect.ownKeys(A));
		},
		getOwnPropertyDescriptor: function (A, g) {
			const B = Reflect.getOwnPropertyDescriptor(A, g);
			return B && !B.get && B.configurable && g !== I && g !== WA && g !== OA
				? (delete B.value, delete B.writable, (B.get = () => A[I][g]), B)
				: B;
		}
	};
	function Ig(A, g, I, B = !1) {
		if (!B && A[g] === I) return;
		const Q = A[g],
			C = A.length;
		void 0 === I ? delete A[g] : (A[g] = I);
		let E,
			e = PA(A);
		((E = _A(e, g, Q)) && E.$(() => I),
			Array.isArray(A) && A.length !== C && (E = _A(e, 'length', C)) && E.$(A.length),
			(E = e._) && E.$());
	}
	function Bg(A, g) {
	...
	function Qg(A, g, I = []) {
		...
		if (g.length > 1) {
			...
			if (E && 'function' === C) {
				for (let Q = 0; Q < A.length; Q++) B(A[Q], Q) && Qg(A, [Q].concat(g), I);
				return;
			}
			if (E && 'object' === C) {
		...
		('function' == typeof C && ((C = C(Q, I)), C === Q)) ||
			(void 0 === B && null == C) ||
			((C = VA(C)), void 0 === B || (zA(Q) && zA(C) && !Array.isArray(C)) ? Bg(Q, C) : Ig(A, B, C));
	}
	function Cg(...[A, g]) {
		const I = VA(A || {}),
			B = Array.isArray(I);
		return [
			...
			function (...A) {
				l(() => {
					B && 1 === A.length
						? (function (A, g) {
								if (('function' == typeof g && (g = g(A)), (g = VA(g)), Array.isArray(g))) {
									if (A === g) return;
									let I = 0,
										B = g.length;
									for (; I < B; I++) {
	...
	function eg(A, g, I, B, Q) {
		...
		if (Array.isArray(A)) {
			if (A.length && C.length && (!B || (Q && A[0] && null != A[0][Q]))) {
				let g, I, E, e, i, t, o, s;
				for (
					E = 0, e = Math.min(C.length, A.length);
					E < e && (C[E] === A[E] || (Q && C[E] && A[E] && C[E][Q] === A[E][Q]));
					E++
				)
					eg(A[E], C, E, B, Q);
				const n = new Array(A.length),
					r = new Map();
				for (
					e = C.length - 1, i = A.length - 1;
					e >= E && i >= E && (C[e] === A[i] || (Q && C[E] && A[E] && C[e][Q] === A[i][Q]));
					e--, i--
				)
					n[i] = C[e];
				if (E > i || E > e) {
					for (I = E; I <= i; I++) Ig(C, I, A[I]);
					for (; I < A.length; I++) (Ig(C, I, n[I]), eg(A[I], C, I, B, Q));
				...
				for (g = E; g <= e; g++)
					((t = C[g]),
						(s = Q && t ? t[Q] : t),
						(I = r.get(s)),
						void 0 !== I && -1 !== I && ((n[I] = C[g]), (I = o[I]), r.set(s, I)));
				for (I = E; I < A.length; I++)
					I in n ? (Ig(C, I, n[I]), eg(A[I], C, I, B, Q)) : Ig(C, I, A[I]);
		...
		for (let g = 0, I = e.length; g < I; g++) void 0 === A[e[g]] && Ig(C, e[g], void 0);
	}
	function ig(A, g = {}) {
		const { merge: I, key: B = 'id' } = g,
			Q = VA(A);
		return (A) => {
			if (!zA(A) || !zA(Q)) return Q;
			const g = eg(Q, { [Eg]: A }, Eg, I, B);
			return void 0 === g ? A : g;
		};
	}
	const tg = X('<span></span>');
	var og = (A) =>
		(() => {
			...
			return (
				...
				w(
					(I) => {
						const B = (function (A, g) {
								const I = A.get('inverse') ? (A.has('bg') ? A.get('bg') : 'bg') : A.get('fg'),
									B = A.get('inverse') ? (A.has('fg') ? A.get('fg') : 'fg') : A.get('bg'),
									Q = sg(I, A.get('bold'), 'fg-'),
									C = sg(B, A.get('blink'), 'bg-');
								let E = g ?? '';
								Q && (E += ' ' + Q);
								C && (E += ' ' + C);
								A.has('bold') && (E += ' ap-bright');
							...
							Q = (function (A) {
								const g = A.get('inverse') ? A.get('bg') : A.get('fg'),
						...
						return (B !== I._v$ && V(g, (I._v$ = B)), (I._v$2 = _(g, Q, I._v$2)), I);
					},
	...
	const ng = X('<span class="ap-line" role="paragraph"></span>');
	var rg = (A) =>
		(() => {
			const g = ng.cloneNode(!0);
			return (
				AA(
					g,
					b(x, {
						get each() {
							return (() => {
								if ('number' == typeof A.cursor) {
									...
									let I = 0,
										B = 0;
									for (; B < A.segments.length && I + A.segments[B][0].length - 1 < A.cursor; ) {
										const Q = A.segments[B];
									...
									if (B < A.segments.length) {
										const Q = A.segments[B],
											C = Q[1],
											E = new Map(C);
										E.set('inverse', !E.get('inverse'));
										const e = A.cursor - I;
										for (
											e > 0 && g.push([Q[0].substring(0, e), Q[1]]),
												g.push([Q[0][e], C, ' ap-cursor-a']),
												g.push([Q[0][e], E, ' ap-cursor-b']),
												e < Q[0].length - 1 && g.push([Q[0].substring(e + 1), Q[1]]),
												B++;
											B < A.segments.length;
										) {
											const I = A.segments[B];
											(g.push(I), B++);
										}
									}
									return g;
				...
				w(() => g.style.setProperty('height', A.height)),
				g
			);
		})();
	const ag = X('<pre class="ap-terminal" aria-live="polite" tabindex="0"></pre>');
	var cg = (A) => {
		...
		return (() => {
			const B = ag.cloneNode(!0),
				Q = A.ref;
			return (
				'function' == typeof Q ? $(Q, B) : (A.ref = B),
				AA(
					B,
					b(v, {
						get each() {
						...
						children: (I, B) =>
							b(rg, {
								...
								get cursor() {
									return h(() => B() === A.cursor?.[1])() ? A.cursor?.[0] : null;
								},
								get height() {
									return `${g()}em`;
								}
				...
				w(
					(g) => {
						const Q = !(!A.blink && !A.cursorHold),
							...
							E = I();
						return (
							Q !== g._v$ && B.classList.toggle('ap-cursor', (g._v$ = Q)),
							C !== g._v$2 && B.classList.toggle('ap-blink', (g._v$2 = C)),
							(g._v$3 = _(B, E, g._v$3)),
							g
						);
					},
	...
	const Dg = X(
			'<svg version="1.1" viewBox="0 0 12 12" class="ap-icon" aria-label="Pause" role="button" tabindex="0"><path d="M1,0 L4,0 L4,12 L1,12 Z"></path><path d="M8,0 L11,0 L11,12 L8,12 Z"></path></svg>'
		),
		wg = X(
			'<svg version="1.1" viewBox="0 0 12 12" class="ap-icon" aria-label="Play" role="button" tabindex="0"><path d="M1,0 L11,6 L1,12 Z"></path></svg>'
		),
		hg = X('<span class="ap-playback-button"></span>'),
		lg = X(
			'<span class="ap-progressbar"><span class="ap-bar"><span class="ap-gutter"><span class="ap-gutter-fill"></span></span></span></span>'
		),
		yg = X(
		...
		Gg = X(
			'<span class="ap-marker-container"><span class="ap-marker"></span><span class="ap-marker-tooltip"></span></span>'
		);
	function Mg(A) {
		let g = Math.floor(A);
		const I = Math.floor(g / 86400);
		g %= 86400;
		const B = Math.floor(g / 3600);
		g %= 3600;
	...
	var Ng = (A) => {
		const g = (A) => (g) => {
			...
			I = () => ('number' == typeof A.currentTime ? Mg(A.currentTime) : '--:--'),
			B = () => ('number' == typeof A.remainingTime ? '-' + Mg(A.remainingTime) : I()),
			Q = h(() =>
				'number' == typeof A.duration ? A.markers.filter((g) => g[0] < A.duration) : []
			),
			C = (A) => {
				const g = A.currentTarget.offsetWidth,
					I = A.currentTarget.getBoundingClientRect(),
					B = A.clientX - I.left;
				return 100 * Math.max(0, B / g) + '%';
			},
			[E, e] = D(!1),
			i = (function (A, g) {
				let I = !0;
				return function () {
					if (I) {
						I = !1;
						for (var B = arguments.length, Q = new Array(B), C = 0; C < B; C++) Q[C] = arguments[C];
						(A.apply(this, Q), setTimeout(() => (I = !0), g));
					}
				};
			})(A.onSeekClick, 50),
			t = (g) => {
				...
				return (
					...
					AA(
						...
						b(j, {
							...
							get children() {
								const I = hg.cloneNode(!0);
								return (
									P(I, 'click', g(A.onPlayClick), !0),
									AA(
										I,
										b(T, {
											get children() {
											...
											children: (I, B) =>
												(() => {
													...
													return (
														...
														AA(E, () =>
															((A) => ('' === A[1] ? Mg(A[0]) : `${Mg(A[0])} - ${A[1]}`))(I)
														),
														w(
															(g) => {
																const B = ((g) => (g[0] / A.duration) * 100 + '%')(I),
																	E = !!((g) =>
																		'number' == typeof A.currentTime && g[0] <= A.currentTime)(I);
																return (
																	B !== g._v$ && Q.style.setProperty('left', (g._v$ = B)),
																	E !== g._v$2 &&
																		C.classList.toggle('ap-marker-past', (g._v$2 = E)),
																	g
																);
															},
															{ _v$: void 0, _v$2: void 0 }
					...
					P(s, 'click', g(A.onFullscreenClick), !0),
					w(() => C.classList.toggle('ap-seekable', !!A.isSeekable)),
					C
				);
			})()
		);
	};
	z(['click', 'mousedown', 'mousemove']);
	const ug = X('<div class="ap-overlay ap-overlay-error"><span>💥</span></div>');
	var Fg = (A) => ug.cloneNode(!0);
	const dg = X('<div class="ap-overlay ap-overlay-loading"><span class="ap-loader"></span></div>');
	var fg = (A) => dg.cloneNode(!0);
	const Yg = X(
		'<div class="ap-overlay ap-overlay-offline bg-default"><span class="fg-default">Stream offline</span></div>'
	);
	var Rg = (A) =>
		(() => {
			const g = Yg.cloneNode(!0),
				I = g.firstChild;
			return (w((g) => _(I, { 'font-family': A.fontFamily }, g)), g);
		})();
	const Jg = X(
	...
	z(['click']);
	const Sg = X('<div class="ap-wrapper" tabindex="-1"><div></div></div>');
	var Lg = (A) => {
		const g = A.logger,
			I = A.core,
			B = A.autoPlay,
			...
			c = () => E().rows || 24,
			y = () => (!1 === A.controls ? 0 : 32);
		let k, N, u, F, d, f, Y, R, J;
		function p() {
			(gA(), X(), z());
		}
		function S(A) {
			(A.rows < E().rows && C('lines', Q.lines.slice(0, A.rows)), e(A));
		}
		function L(A) {
			void 0 === A || B || C({ lines: A.lines, cursor: A.cursor });
		}
		(I.addEventListener('init', (A) => {
			let { cols: g, rows: I, duration: B, poster: Q, markers: C } = A;
			(S({ cols: g, rows: I }), t(B), s(C), L(Q));
		}),
			I.addEventListener('play', () => {
				C('showStartOverlay', !1);
			}),
			I.addEventListener('playing', () => {
				(C('coreState', 'playing'), H(), P(), O());
			}),
			I.addEventListener('stopped', () => {
				(C('coreState', 'stopped'), p());
			}),
			I.addEventListener('loading', () => {
				(C('coreState', 'loading'), p());
			}),
			I.addEventListener('offline', () => {
				(C('coreState', 'offline'), p());
			}),
			I.addEventListener('errored', () => {
				C({ coreState: 'errored', showStartOverlay: !1 });
			}),
			...
			I.addEventListener('terminalUpdate', () => {
				void 0 === k && (k = requestAnimationFrame(H));
			}));
		const U = () => {
			((J = new ResizeObserver(
				(function (A, g) {
					...
					(C({ containerW: d.offsetWidth, containerH: d.offsetHeight }),
						d.dispatchEvent(new CustomEvent('resize', { detail: { el: f } })));
				}, 10)
			)),
				J.observe(d));
		};
		(G(async () => {
			(g.info('player mounted'),
				g.debug('font measurements', { charW: Q.charW, charH: Q.charH }),
				U());
			const { isPausable: A, isSeekable: E, poster: e } = await I.init();
			(C({ isPausable: A, isSeekable: E, containerW: d.offsetWidth, containerH: d.offsetHeight }),
				L(e),
				B && I.play());
		}),
			M(() => {
				(I.stop(), gA(), X(), J.disconnect());
			}));
		const H = () => {
				const A = I.getChangedLines();
				(A &&
					l(() => {
						A.forEach((A, g) => {
							C('lines', g, ig(A));
					...
					C('cursor', ig(I.getCursor())),
					C('cursorHold', !0),
					(k = void 0));
			},
			K = h(() => {
				g.debug(`containerW = ${Q.containerW}`);
				const I = Q.charW * a() + Q.bordersW,
					B = Q.charH * c() + Q.bordersH;
				let C = A.fit ?? 'width';
				if ('both' === C || Q.isFullscreen) {
					C = Q.containerW / (Q.containerH - y()) > I / B ? 'height' : 'width';
				}
				if (!1 === C || 'none' === C) return {};
				if ('width' === C) {
					const A = Q.containerW / I;
					return { scale: A, width: Q.containerW, height: B * A + y() };
				}
				if ('height' === C) {
					const A = (Q.containerH - y()) / B;
					return { scale: A, width: I * A, height: Q.containerH };
				}
			...
			q = () => {
				Q.isFullscreen
					...
					: (d.requestFullscreen ?? d.webkitRequestFullscreen ?? (() => {})).apply(d);
			},
			v = (A) => {
				if (!(A.altKey || A.metaKey || A.ctrlKey))
					if (A.shiftKey) {
						if ('ArrowLeft' == A.key) I.seek('<<<');
						else {
						...
						if (' ' == A.key) I.togglePlay();
						else if ('.' == A.key) (I.step(), z());
						else if ('f' == A.key) q();
						else if ('ArrowLeft' == A.key) I.seek('<<');
						else if ('ArrowRight' == A.key) I.seek('>>');
						else if ('[' == A.key) I.seek({ marker: 'prev' });
						else if (']' == A.key) I.seek({ marker: 'next' });
						else {
			...
			z = () => {
				const A = I.getCurrentTime(),
					g = I.getRemainingTime(),
					B = I.getProgress();
				C({ currentTime: A, remainingTime: g, progress: B });
			},
			P = () => {
				F = setInterval(() => {
					C((A) => {
						const g = { blink: !A.blink };
						return (g.blink && (g.cursorHold = !1), g);
					});
				}, 500);
			},
			gA = () => {
				(clearInterval(F), C('blink', !0));
			},
			IA = (A) => {
				(clearTimeout(N), A && (N = setTimeout(() => IA(!1), 2e3)), r(A));
			},
			BA = (() => {
				const g = Sg.cloneNode(!0),
					B = g.firstChild;
				('function' == typeof d ? $(d, g) : (d = g),
					g.addEventListener('webkitfullscreenchange', m),
					g.addEventListener('fullscreenchange', m),
					(g.$$mousemove = x),
					(g.$$keydown = v),
					g.addEventListener('keypress', v));
				return (
					'function' == typeof f ? $(f, B) : (f = B),
					(B.$$mousemove = () => IA(!0)),
					B.addEventListener('mouseleave', W),
					AA(
						B,
						b(cg, {
							get cols() {
						...
						b(j, {
							...
							get children() {
								return b(Ng, {
									...
									onPlayClick: () => I.togglePlay(),
									onFullscreenClick: q,
									onSeekClick: (A) => I.seek(A),
									ref(A) {
							...
							get children() {
								return [
									b(Z, {
										...
										get children() {
											return b(pg, { onClick: () => I.play() });
										}
									}),
									b(Z, {
										get when() {
											return 'loading' == Q.coreState;
										},
										get children() {
											return b(fg, {});
										}
					...
					w(
						(I) => {
							const Q = !!(!0 === A.controls || ('auto' === A.controls && n())),
								C = `ap-player asciinema-theme-${A.theme ?? 'asciinema'}`,
								E = (() => {
									const g = {};
									(!1 !== A.fit && 'none' !== A.fit) ||
									...
									return (
										void 0 !== I.width &&
											((g.width = `${I.width}px`), (g.height = `${I.height}px`)),
										g
									);
								})();
							return (
								Q !== I._v$ && g.classList.toggle('ap-hud', (I._v$ = Q)),
								C !== I._v$2 && V(B, (I._v$2 = C)),
								(I._v$3 = _(B, E, I._v$3)),
								I
							);
						},
	...
	class Hg {
		constructor(A, g) {
			((this.logger = A), (this.prefix = g));
		}
		log(A) {
			for (var g = arguments.length, I = new Array(g > 1 ? g - 1 : 0), B = 1; B < g; B++)
				I[B - 1] = arguments[B];
			this.logger.log(`${this.prefix}${A}`, ...I);
		}
		debug(A) {
			for (var g = arguments.length, I = new Array(g > 1 ? g - 1 : 0), B = 1; B < g; B++)
				I[B - 1] = arguments[B];
			this.logger.debug(`${this.prefix}${A}`, ...I);
		}
		info(A) {
			for (var g = arguments.length, I = new Array(g > 1 ? g - 1 : 0), B = 1; B < g; B++)
				I[B - 1] = arguments[B];
			this.logger.info(`${this.prefix}${A}`, ...I);
		}
		warn(A) {
			for (var g = arguments.length, I = new Array(g > 1 ? g - 1 : 0), B = 1; B < g; B++)
				I[B - 1] = arguments[B];
			this.logger.warn(`${this.prefix}${A}`, ...I);
		}
		error(A) {
			for (var g = arguments.length, I = new Array(g > 1 ? g - 1 : 0), B = 1; B < g; B++)
				I[B - 1] = arguments[B];
			this.logger.error(`${this.prefix}${A}`, ...I);
		}
	}
	class Kg {
		constructor(A, g) {
			((this.input = 'function' == typeof A.next ? A : A[Symbol.iterator]()), (this.xfs = g ?? []));
		}
		map(A) {
		...
		multiplex(A, g) {
			return new Kg(new qg(this[Symbol.iterator](), A[Symbol.iterator](), g));
		}
		toArray() {
		...
		[Symbol.iterator]() {
			...
			return {
				next: () => {
					for (A === g.length && ((g = []), (A = 0)); 0 === g.length; ) {
						const A = this.input.next();
						if (A.done) break;
						B.step(A.value);
					}
					return (
						0 !== g.length || I || (B.flush(), (I = !0)),
						g.length > 0 ? { done: !1, value: g[A++] } : { done: !0 }
					);
				}
			};
		}
	...
	class qg {
		constructor(A, g, I) {
			((this.left = A), (this.right = g), (this.comparator = I));
		}
		[Symbol.iterator]() {
			let A, g;
			return {
				next: () => {
					...
					if (void 0 === A && void 0 === g) return { done: !0 };
					if (void 0 === A) {
						const A = g;
						return ((g = void 0), { done: !1, value: A });
					}
					if (void 0 === g) {
						const g = A;
						return ((A = void 0), { done: !1, value: g });
					}
			...
			const B = await A.text(),
				Q = (function (A) {
					...
					const B = new Kg(g)
						...
						.map(JSON.parse)
						.toArray();
					return { header: I, events: B };
				})(B);
			void 0 !== Q ? ((g = Q.header), (I = Q.events)) : (g = JSON.parse(B));
		} else if ('object' == typeof A && 'number' == typeof A.version) g = A;
		else {
			if (!Array.isArray(A)) throw 'invalid data';
			((g = A[0]), (I = A.slice(1, A.length)));
		}
		if (1 === g.version)
			return (function (A) {
				let g = 0;
				const I = new Kg(A.stdout).map((A) => ((g += A[0]), [g, 'o', A[1]]));
				return { cols: A.width, rows: A.height, events: I };
			})(g);
		if (2 === g.version)
			return (function (A, g) {
				return { cols: A.width, rows: A.height, events: g, idleTimeLimit: A.idle_time_limit };
			})(g, I);
		throw `asciicast v${g.version} format not supported`;
	}
	function vg(A) {
		if ('r' === A[1]) {
			const [g, I] = A[2].split('x');
			return [A[0], 'o', `[8;${I};${g};t`];
		}
		return A;
	}
	function xg(A) {
	...
	function jg() {
		let A = 0;
		return function (g) {
			return 'm' === g[1] ? [g[0], g[1], { index: A++, time: g[0], label: g[2] }] : g;
		};
	}
	class Tg {
		constructor() {
		...
		push(A) {
			(this.items.push(A),
				void 0 !== this.onPush && (this.onPush(this.popAll()), (this.onPush = void 0)));
		}
		popAll() {
	...
	function Zg(A, g, I, B, Q) {
		return I > 0
			? (function (A, g, I, B) {
					let Q = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 1 / 60;
					const C = new Tg(),
						E = Wg();
					let e = !1,
						i = -Q;
	...
	function zg(A) {
		...
		const g = (function (A) {
				const g = Vg(A.subarray(0, 4)),
					I = Vg(A.subarray(4, 8));
				return g + I / 1e6;
			})(A.subarray(0, 8)),
			I = Vg(A.subarray(8, 12));
		return { time: g, data: A.subarray(12, 12 + I), len: I + 12 };
	}
	function Vg(A) {
	...
	const Pg = new Map([
			[
				...
				function (A, g) {
					let I,
						{ url: B, iterations: Q = 10 } = A,
						{ feed: C, now: E } = g,
						e = 0;
					return {
						async init() {
							const A = await bg(await fetch(B)),
							...
							const E = I[I.length - 1][0];
							for (const [A, g] of I) e += new Blob([g]).size;
							return { cols: g, rows: Q, duration: E };
						},
						play() {
							const A = E();
							for (let A = 0; A < Q; A++) {
								for (const [A, g] of I) C(g);
								C('c');
							}
							const g = (E() - A) / 1e3,
								B = (e * Q) / g,
			...
			[
				'clock',
				function (A, g, I) {
					let { hourColor: B = 3, minuteColor: Q = 4, separatorColor: C = 9 } = A,
						{ feed: E } = g,
						{ cols: e = 5, rows: i = 1 } = I;
					...
					return {
						init: () => {
							const A = [s].concat(r());
							return { cols: e, rows: i, duration: 1440, poster: A };
						},
						play: () => (E(s), a(), (n = setInterval(a, 1e3)), !0),
						stop: () => {
							clearInterval(n);
						},
						getCurrentTime: () => {
			...
			[
				...
				function (A, g) {
					let I,
						B,
						{ url: Q, bufferTime: C = 0.1, minFrameTime: E } = A,
						{ feed: e, reset: i, setState: t, logger: o } = g;
					o = new Hg(o, 'eventsource: ');
					let s = new UA();
					function n(A) {
						(void 0 !== B && B.stop(), (B = Zg(e, (A) => s.setTime(A), C, A, E)));
					}
					return {
						play: () => {
							((I = new EventSource(Q)),
								...
								I.addEventListener('error', (A) => {
									(o.info('errored'), o.debug({ e: A }), t('loading'));
								}),
								I.addEventListener('message', (A) => {
									const g = JSON.parse(A.data);
									if (Array.isArray(g)) B.pushEvent(g);
									else if (void 0 !== g.cols || void 0 !== g.width) {
										const A = g.cols ?? g.width,
											I = g.rows ?? g.height;
										(o.debug(`vt reset (${A}x${I})`),
											t('playing'),
											n(g.time),
											i(A, I, g.init ?? void 0),
											(s = new LA()),
											'number' == typeof g.time && s.setTime(g.time));
									} else
										'offline' === g.state &&
											(o.info('stream offline'), t('offline'), (s = new UA()));
								}),
								I.addEventListener('done', () => {
									(o.info('closed'), I.close(), t('stopped', { reason: 'ended' }));
								}));
						},
						stop: () => {
							(void 0 !== B && B.stop(), void 0 !== I && I.close());
						},
						getCurrentTime: () => s.getTime()
					};
				}
			],
			[
			...
			[
				...
				function (A, g, I) {
					let B,
						...
						o,
						s,
						{ feed: n, onInput: r, onMarker: a, now: c, setTimeout: D, setState: w, logger: h } = g,
						{
							idleTimeLimit: l,
							startAt: y,
							loop: G,
					...
					async function R(A, g) {
						...
						if (!I.ok) throw `failed fetching recording from ${A}: ${I.status} ${I.statusText}`;
						return I;
					}
					function J() {
						const A = C[d];
						A
							...
							: (S(),
								Y++,
								!0 === G || ('number' == typeof G && Y < G)
									? ((d = 0), (o = c()), n('c'), q(), J())
									: ((s = 1e3 * e), (i = null), w('stopped', { reason: 'ended' })));
					}
					function p() {
						let A,
							g = C[d];
					...
					function L(A) {
						...
						if ('o' === I) n(B);
							...
							return (U(), (s = 1e3 * g), w('stopped', { reason: 'paused' }), !0);
						return !1;
					}
					function U() {
						return !t || (S(), (s = c() - o), !0);
					...
					function K(A) {
						...
						if ('string' == typeof A)
							...
							if ('prev' === A.marker) ((A = m(I) ?? 0), g && I - A < 1 && (A = m(A) ?? 0));
								...
								A =
									(function (A) {
										...
										let g,
											I = E.length - 1,
											B = E[I];
										for (; B && B[0] > A; ) ((g = B[0]), (B = E[--I]));
										return g;
									})(I) ?? e;
							else if ('number' == typeof A.marker) {
								const g = E[A.marker];
								if (void 0 === g) throw `invalid marker index: ${A.marker}`;
								A = g[0];
							}
						const B = Math.min(Math.max(A, 0), e);
						B < f && (n('c'), q(), (d = 0), (f = 0));
						let Q = C[d];
						for (; Q && Q[0] <= B; ) ('o' === Q[1] && L(Q), (f = Q[0]), (Q = C[++d]));
						return ((s = 1e3 * B), (i = null), g && H(), !0);
					}
					function m(A) {
						if (0 == E.length) return;
						let g,
						...
						init: async function () {
							const {
								...
								n = (function (A, g, I) {
									...
									void 0 === i &&
										(i = (function (A) {
											let { output: g = [], input: I = [], markers: B = [] } = A;
											const Q = new Kg(g).map((A) => [A[0], 'o', A[1]]),
												C = new Kg(I).map((A) => [A[0], 'i', A[1]]),
												E = new Kg(B).map(xg);
											return Q.multiplex(C, (A, g) => A[0] < g[0]).multiplex(
												E,
												(A, g) => A[0] < g[0]
											);
										})(A));
									...
									((i = i
										...
										.transform(
											(function (A) {
												let g,
													I =
														arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 1 / 60;
												return (B) => {
													let Q = 0,
														C = 0;
													return {
										...
										void 0 !== e &&
											...
											(i = i
												.filter((A) => 'm' !== A[1])
												.multiplex(e, (A, g) => A[0] < g[0])
												.map(jg()))));
									((i = i.toArray()),
										void 0 !== E &&
											((i = i.map((A) => ('i' === A[1] ? [A[0] + E, A[1], A[2]] : A))),
											i.sort((A, g) => A[0] - g[0])));
									const o = i[i.length - 1][0],
										s = B - t.offset;
									return { ...A, events: i, duration: o, effectiveStartAt: s };
								})(
									await g(
										await (function (A) {
											let { url: g, data: I, fetchOpts: B = {} } = A;
											if ('string' == typeof g) return R(g, B);
											if (Array.isArray(g)) return Promise.all(g.map((A) => R(A, B)));
											if (void 0 !== I)
												return (
													'function' == typeof I && (I = I()),
													I instanceof Promise || (I = Promise.resolve(I)),
													I.then((A) =>
														'string' == typeof A || A instanceof ArrayBuffer ? new Response(A) : A
													)
												);
									...
									h,
									{ idleTimeLimit: l, startAt: y, minFrameTime: I, inputOffset: t, markers_: k }
								);
							if (
								(({ cols: B, rows: Q, events: C, duration: e, effectiveStartAt: i } = n),
								(u = u ?? B),
								(F = F ?? Q),
								0 === C.length)
							)
							...
							void 0 !== o &&
								(function (A, g) {
									const I = document.createElement('a'),
										B = A.events.map((A) => ('m' === A[1] ? [A[0], A[1], A[2].label] : A)),
										Q = (function (A) {
											return `${JSON.stringify({ version: 2, width: A.cols, height: A.rows })}\n${A.events.map(JSON.stringify).join('\n')}\n`;
										})({ ...A, events: B });
									((I.href = URL.createObjectURL(new Blob([Q], { type: 'text/plain' }))),
										(I.download = g),
										I.click());
								})(n, o);
							const r =
								void 0 !== M
									? ((a = M), C.filter((A) => A[0] < a && 'o' === A[1]).map((A) => A[2]))
									: void 0;
							var a;
							return (
								(E = C.filter((A) => 'm' === A[1]).map((A) => [A[0], A[2].label])),
								{ cols: B, rows: Q, duration: e, poster: r, markers: E }
							);
						},
						play: function () {
							return (t || (void 0 === C[d] && (i = 0), null !== i && K(i), H()), !0);
						},
						pause: U,
						seek: K,
						step: function () {
			...
			[
				'websocket',
				function (A, g) {
					let { url: I, bufferTime: B = 0.1, reconnectDelay: Q = Xg, minFrameTime: C } = A,
					...
					let s,
						...
						D = !1;
					function w(A) {
						(void 0 !== n && n.stop(), (n = Zg(E, (A) => a.setTime(A), B, A, C)));
					}
					function h(A) {
						if ('string' == typeof A.data)
							(t.info('activating asciicast-compatible handler'), (s.onmessage = l), l(A));
						else {
							const g = new Uint8Array(A.data);
							if (65 == g[0] && 76 == g[1] && 105 == g[2] && 83 == g[3])
								if (1 == g[4]) {
									t.info('activating ALiS v1 handler');
									const A = g[5];
									(0 == A
										? t.debug('text compression: none')
										: (t.error(`unsupported compression algorithm (${A})`), s.close()),
										(s.onmessage = y));
								} else (t.warn(`unsupported ALiS version (${g[4]})`), s.close());
							else {
								...
								const I = o.decode(g),
									B =
										(function (A) {
											...
											if (null !== g) return [parseInt(g[2], 10), parseInt(g[1], 10)];
										})(I) ??
										(function (A) {
											const g = A.match(/\[.*COLUMNS="(\d{1,3})" LINES="(\d{1,3})".*\]/);
											if (null !== g) return [parseInt(g[1], 10), parseInt(g[2], 10)];
										})(I);
								if (void 0 !== B) {
									const [A, g] = B;
									M(A, g, 0, void 0);
					...
					function l(A) {
						...
						Array.isArray(g)
							? n.pushEvent(g)
							: void 0 !== g.cols || void 0 !== g.width
								? M(g.cols ?? g.width, g.rows ?? g.height, g.time, g.init ?? void 0)
								: 'offline' === g.status && k();
					}
					function y(A) {
						const g = A.data,
							...
							B = I.getUint8(0);
						if (1 === B) {
							const A = I.getUint16(1, !0),
								B = I.getUint16(3, !0),
								Q = I.getFloat32(5, !0),
								C = I.getUint32(9, !0);
							M(A, B, Q, C > 0 ? o.decode(new Uint8Array(g, 13, C)) : void 0);
						} else if (111 === B) {
							const A = I.getFloat32(1, !0),
								B = I.getUint32(5, !0),
								Q = o.decode(new Uint8Array(g, 9, B));
							n.pushEvent([A, 'o', Q]);
						} else if (114 === B) {
							const A = I.getFloat32(1, !0),
								g = I.getUint16(5, !0),
								B = I.getUint16(7, !0);
							n.pushEvent([A, 'r', `${g}x${B}`]);
						} else 4 === B ? k() : t.debug(`unknown frame type: ${B}`);
					}
					function G(A) {
						n.pushText(o.decode(A.data));
					}
					function M(A, g, I, B) {
						(t.debug(`stream reset (${A}x${g} @${I})`),
							i('playing'),
							w(I),
							e(A, g, B),
							(a = new LA()),
							'number' == typeof I && a.setTime(I));
					}
					function k() {
						(t.info('stream offline'), i('offline'), (a = new UA()));
					}
					function N() {
						((s = new WebSocket(I)),
							...
							(s.onmessage = h),
							(s.onclose = (A) => {
								if (D || 1e3 === A.code || 1005 === A.code)
									(t.info('closed'), i('stopped', { reason: 'ended' }));
								else {
									clearTimeout(r);
									const A = Q(c++);
					...
					return {
						...
						stop: () => {
							((D = !0), void 0 !== n && n.stop(), void 0 !== s && s.close());
						},
			...
			[
				...
				async function (A, g) {
					...
					const e = await A[1].arrayBuffer(),
						...
						o = B.decode(i.subarray(0, t)).match(/COLUMNS="(\d+)" LINES="(\d+)"/);
					null !== o && ((Q = parseInt(o[1], 10)), (C = parseInt(o[2], 10)));
					const s = { array: i, cursor: t };
					let n = s;
					if (void 0 !== A[2]) {
						const g = await A[2].arrayBuffer();
						n = { array: new Uint8Array(g), cursor: t };
					}
					const r = [];
					let a = 0;
					for (const A of E)
						if (((a += parseFloat(A[1])), 'O' === A[0])) {
							const g = parseInt(A[2], 10),
								I = s.array.subarray(s.cursor, s.cursor + g),
								Q = B.decode(I);
							(r.push([a, 'o', Q]), (s.cursor += g));
						} else if ('I' === A[0]) {
							const g = parseInt(A[2], 10),
								I = n.array.subarray(n.cursor, n.cursor + g),
								Q = B.decode(I);
							(r.push([a, 'i', Q]), (n.cursor += g));
						} else if ('S' === A[0] && 'SIGWINCH' === A[2]) {
							const g = parseInt(A[4].slice(5), 10),
								I = parseInt(A[3].slice(5), 10);
							r.push([a, 'r', `${g}x${I}`]);
						} else
							'H' === A[0] && 'COLUMNS' === A[2]
								? (Q = parseInt(A[3], 10))
								: 'H' === A[0] && 'LINES' === A[2] && (C = parseInt(A[3], 10));
					return ((Q = Q ?? 80), (C = C ?? 24), { cols: Q, rows: C, events: r });
				}
			],
			[
				'ttyrec',
				async function (A, g) {
					...
					const B = new TextDecoder(I),
						...
						E = zg(C),
						e = E.time,
						i = B.decode(E.data).match(/\x1b\[8;(\d+);(\d+)t/),
						t = [];
					let o = 80,
						s = 24;
					null !== i && ((o = parseInt(i[2], 10)), (s = parseInt(i[1], 10)));
					let n = 0,
						r = zg(C);
					for (; void 0 !== r; ) {
						const A = r.time - e,
							g = B.decode(r.data);
						(t.push([A, 'o', g]), (n += r.len), (r = zg(C.subarray(n))));
					}
					return { cols: o, rows: s, events: t };
				}
			]
		]);
	return (
			...
			const B = I.logger ?? new Ug(),
				Q = new TA(
					(function (A) {
						...
						if (
							'recording' == A.driver &&
							(void 0 === A.parser && (A.parser = 'asciicast'), 'string' == typeof A.parser)
						) {
							if (!_g.has(A.parser)) throw `unknown parser: ${A.parser}`;
							A.parser = _g.get(A.parser);
						}
						if (Pg.has(A.driver)) {
							const g = Pg.get(A.driver);
							return (I, B) => g(A, I, B);
						}
					...
					})(A),
					{
						...
						poster: I.poster,
						markers: I.markers,
						pauseOnMarkers: I.pauseOnMarkers,
				...
				C = (function (A, g) {
					...
					const E = O(
							() => ((C = b(cg, { cols: I, rows: B, lineHeight: g, fontFamily: A, lines: [] })), C),
							Q
						),
						e = {
							charW: C.clientWidth / I,
							charH: C.clientHeight / B,
							bordersW: C.offsetWidth - C.clientWidth,
							bordersH: C.offsetHeight - C.clientHeight
						};
					return (E(), document.body.removeChild(Q), e);
				})(I.terminalFontFamily, I.terminalLineHeight),
				E = {
					logger: B,
					core: Q,
					cols: I.cols,
