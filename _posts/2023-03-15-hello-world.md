---
title: Syntax Reference for Posts
author: Lennard Wolf
layout: post
---

{% abstract %}
This project uses jekyll-latex, which allows me to write markdown posts using the Jekyll framework with the beautiful typography of <span class="latex">L<span>a</span>T<span>e</span>X</span> and the MathJax library so you can render gorgeous equations like this one below:
$$ J(\theta) =\frac{1}{2m}
...
{% raw %}
{% abstract %}
This project uses jekyll-latex, which features the beautiful
